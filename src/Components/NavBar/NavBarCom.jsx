                ...
                <Container fluid className='flex'>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav
                            ...
                            navbarScroll
                        >
                            <Link className='rb-nav-link' to={'/'}><h5>Home</h5></Link>
                            <Link className='rb-nav-link' to={'/Courses'}><h5>Courses</h5></Link>
                            <Link className='rb-nav-link' to={'/Blog'}><h5>Blog</h5></Link>
                            <h5><NavDropdown title="Page" className='rb-Dropdown-nav' id="navbarScrollingDropdown">
